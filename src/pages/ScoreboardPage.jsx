...
import { Search, TrendingUp, Clock, Users, Flag, ArrowRight } from 'lucide-react'
      ...
      <div className="relative z-10">
        ...
        <div className="grid lg:grid-cols-[minmax(0,1fr)_24rem] gap-6 items-start">
                  ...
                  {filtered.map((team, i) => (
                    <tr
                      ...
                      className={`border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors ${
                        selectedTeam?.id === team.id ? 'bg-gray-50' : team.rank <= 3 ? 'bg-yellow-50/30' : ''
                      }`}
                    >
          ...
          <aside className="lg:sticky lg:top-24">
            <div className="card p-6 shadow-sm min-h-[24rem]">
              {selectedTeam ? (
                <>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        <span className="flex items-center gap-1.5 text-sm text-gray-500">
                          <span className={`w-2 h-2 rounded-full ${statusDot(selectedTeam.status)}`} />
                          {selectedTeam.status}
                        </span>
